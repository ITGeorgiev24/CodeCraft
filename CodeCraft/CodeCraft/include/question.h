// ============================================================
// question.h  --  Question struct, Category enum, bank loader
// ============================================================
#pragma once
#include <string>
#include <vector>
...
enum class Category { ALGEBRA, GEOMETRY, FUNCTIONS, PROBABILITY, NUMBER_THEORY };
