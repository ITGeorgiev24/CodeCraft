...
vector<Question> makeBank() {
    return {
        ...
        { 1, "Solve:  2x + 4 = 10",
          {"x = 2", "x = 3", "x = 4", "x = 5"},
          1, Category::ALGEBRA, 1 },

        { 2, "Simplify:  3(x + 2) - 2(x - 1)",
          {"x + 4", "x + 6", "x + 8", "2x + 4"},
          2, Category::ALGEBRA, 1 },

        { 3, "What is  x^2  when  x = -5 ?",
          {"-25", "-10", "10", "25"},
          3, Category::ALGEBRA, 1 },
        ...
        { 5, "Expanded form of  (a + b)^2 ?",
          {"a^2 + b^2", "a^2 + ab + b^2", "a^2 + 2ab + b^2", "2a + 2b"},
          2, Category::ALGEBRA, 1 },
        ...
        { 8, "Simplify:  x^2 * x^3",
          ...
          { 9, "Area of a circle with radius 5?  (pi = 3.14)",
            {"15.7", "31.4", "78.5", "25"},
            2, Category::GEOMETRY, 2 },

          { 10, "Area of a triangle: base = 6, height = 4?",
             {"24", "20", "10", "12"},
             3, Category::GEOMETRY, 2 },

          { 11, "Right triangle: legs a = 3, b = 4.  Find the hypotenuse.",
             {"3.5", "5", "6", "7"},
             1, Category::GEOMETRY, 2 },
          ...
          { 16, "Two supplementary angles together sum to?",
             ...
             { 17, "If f(x) = 2x + 1,  what is f(3)?",
                {"5", "7", "9", "3"},
                1, Category::FUNCTIONS, 2 },

             { 18, "What is the slope of  y = 3x - 2?",
                {"-2", "2", "3", "-3"},
                2, Category::FUNCTIONS, 2 },
             ...
             { 23, "If f(x) = |x| (absolute value),  what is f(-7)?",
                {"-49", "-7", "0", "7"},
                3, Category::FUNCTIONS, 2 },
                ...
                { 24, "Probability of rolling a 6 on a fair die?",
                   {"1/2", "1/3", "1/4", "1/6"},
                   3, Category::PROBABILITY, 3 },

                { 25, "P(A) = 0.3, P(B) = 0.4, P(A and B) = 0.1.  Find P(A or B).",
                   {"0.5", "0.6", "0.7", "0.8"},
                   1, Category::PROBABILITY, 3 },

                { 26, "Probability of drawing an Ace from a 52-card deck?",
                   {"1/52", "1/26", "1/13", "1/4"},
                   2, Category::PROBABILITY, 3 },

                { 27, "Bag: 3 red balls and 7 blue balls.  P(drawing red)?",
                   {"0.3", "0.7", "3/7", "7/3"},
                   0, Category::PROBABILITY, 3 },
                   ...
                   { 29, "LCM of 4 and 6?",
                      {"2", "8", "12", "24"},
                      2, Category::NUMBER_THEORY, 1 },

                   { 30, "How many positive divisors does 12 have?",
                      {"3", "4", "5", "6"},
                      3, Category::NUMBER_THEORY, 1 },
                   ...
                   { 32, "Is 144 a perfect square?",
                      {"No", "Yes", "Only approximately", "Cannot determine"},
                      1, Category::NUMBER_THEORY, 1 },
